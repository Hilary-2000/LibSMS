                                                    ...
                                                    <tbody>
                                                        @for ($i = 0; $i < count($checked_in); $i++)
                                                            <tr>
                                                                ...
                                                                <td>{{date("D dS M Y",strtotime($checked_in[$i]->expected_return_date))}}
                                                                    @if ((date("YmdHis")*1) > ($checked_in[$i]->expected_return_date*1))
                                                                        <span data-bs-toggle="tooltip" data-bs-placement="top" class="badge bg-soft-danger" data-bs-original-title="Overdue {{getDateDifference(date("Ymd"), date("Ymd",strtotime($checked_in[$i]->expected_return_date)), 'days')}}">Overdue</span>
                                                                    @endif
                                                                    @if ((date("Ymd")*1) == (date("Ymd",strtotime($checked_in[$i]->expected_return_date))*1))
